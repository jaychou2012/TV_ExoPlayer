...
public class PlayerControlView extends FrameLayout implements DefaultTimeBar.UpdateStatus {
    ...
    @Override
    public void updateStatusImage(boolean left) {
//        if (iv_fast.getVisibility() == View.GONE) {
//            iv_fast.setVisibility(View.VISIBLE);
//        }
//        iv_fast.setImageResource(left ? R.mipmap.icon_backward : R.mipmap.icon_fast);
    }

    @Override
    public void showImageFast(boolean show) {
//        if (iv_fast.getVisibility() == View.VISIBLE) {
//            iv_fast.setVisibility(View.GONE);
//        }
    }
    ...
    private void playOrPauseStatus(boolean pause) {
        if (playOrPauseStatus != null) {
            playOrPauseStatus.playOrPause(pause);
        }
    }

    public void setPlayOrPauseStatusListener(PlayOrPauseStatus playOrPauseStatus) {
        this.playOrPauseStatus = playOrPauseStatus;
    }

    interface PlayOrPauseStatus {
        void playOrPause(boolean pause);
    }
    ...
    private PlayOrPauseStatus playOrPauseStatus;
    ...
    public PlayerControlView(
        ...
        iv_fast = findViewById(R.id.iv_fast);
        tv_title = findViewById(R.id.tv_info);
        tv_time = findViewById(R.id.tv_time);
        if (timeBar != null) {
            timeBar.addListener(componentListener);
        }
        timeBar.setUpdateStatusListener(this);
        timeBar.setKeyCountIncrement(100);
...
//        updateShuffleButton();
    ...
    private void updatePlayPauseButton() {
        ...
        if (iv_fast != null) {
            requestPlayPauseFocus |= playing && iv_fast.isFocused();
//            iv_fast.setVisibility(playing ? View.GONE : View.VISIBLE);
//            iv_fast.setImageResource(playing ? R.mipmap.icon_pause : R.mipmap.icon_play_blue);
        }
//        if (pauseButton != null) {
