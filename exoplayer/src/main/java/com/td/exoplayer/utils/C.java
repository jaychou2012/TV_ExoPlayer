...
public final class C {
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({TYPE_DASH, TYPE_SS, TYPE_HLS,TYPE_TS, TYPE_OTHER})
     ...
     * {@link Util#getAudioUsageForStreamType(int)} and use the returned {@link com.google.android.exoplayer2.C.AudioUsage} to build
     ...
     * scaling modes in {@link com.google.android.exoplayer2.C.VideoScalingMode}.
     *
