...
public final class CINDEX {
     ...
     * ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be the target {@link Surface}, or
     * null.
     */
     ...
     * ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be a {@link Float} with 0 being
     ...
     * via {@link ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be one of the integer
    ...
    /**
     * A type of a message that can be passed to an audio {@link Renderer} via {@link
     * ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be an {@link AuxEffectInfo}
     ...
     * ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be a {@link CameraMotionListener}
     * instance, or null.
     */
